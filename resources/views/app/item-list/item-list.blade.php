                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="input-group my-2 shadow">
                                            <a tabindex="0" class="input-group-text text-decoration-none text-white border-0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" title="Item number" data-bs-content="Item number"><i class="fa-solid fa-barcode"></i></a>
                                            <input type="number" class="form-control border-0 bg-white" name="item_number" placeholder="{{ __("Item no.") }}" required>
                                        </div>
                                    </div>
                                    {{-- item name group --}}
                                    <div class="col-12">
                                        <div class="input-group my-2 shadow">
                                            <a tabindex="0" class="input-group-text text-decoration-none text-white border-0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" title="Item name" data-bs-content="Item name"><i class="fa-solid fa-tag"></i></a>
                                            <input type="text" class="form-control border-0 bg-white" name="item_name" placeholder="{{ __("Item name") }}" required>
                                        </div>
                                    </div>
                                    {{-- item description group --}}
                                    <div class="col-12">
                                        <div class="input-group my-2 shadow">
                                            <a tabindex="0" class="input-group-text text-decoration-none text-white border-0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" title="Item description" data-bs-content="Item short description"><i class="fa-solid fa-newspaper"></i></a>
                                            <input type="text" class="form-control border-0 bg-white" name="item_description" placeholder="{{ __("Item description") }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <table id="item-list__item-list-table" class="table table-striped w-100">
                ...
                <tbody>
                    @foreach(App\Models\ItemList::getAllItems() as $item)
                        <tr>
                            <td data-order="{{ $item["itemlist_id"] }}" style="vertical-align: middle !important;">{{ __("ID_NO") }}</td>
                            <td style="vertical-align: middle !important;">{{ __($item["itemname"]) }}</td>
