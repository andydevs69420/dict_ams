                    ...
                    @foreach(App\Models\UserVerificationDetails::getAllUsers() as $user)
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle !important;">
                                ...
                                <div class="dropdown">
                                    <button id="action-user-{{ $user["user_id"] }}" class="btn btn-sm @if(strcmp($user["verificationstatus_id"], "1") === 0) btn-danger @else btn-success @endif dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">{{ __("action") }}</button>
