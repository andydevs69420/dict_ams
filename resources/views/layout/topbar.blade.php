...
<nav id="topbar" class="navbar navbar-expand-xxl navbar-light bg-light shadow px-4">
    ...
    <div id="avatar-group" class="d-flex flex-row flex-nowrap align-items-center py-2">
        <span id="avatar-identifier" class="lead text-muted ms-3" style="font-size: .8em;" role="text">{{ $access_level_title }}</span>
